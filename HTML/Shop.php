...
<body>
    <section id="header">
        <a href="Home.php"><img src="../Image/Logo.png" class="logo" alt=""></a>
    ...
    <section id="heroo">
        <h4>Summer Sale</h4>
        <h2>Super <span>Value</span> Deals</h2>
        <button onclick="scrollToProducts()">Buy Now</button>
    </section>
    ...
    <section id="gym" class="section-p1">
        ...
        <div class="pro-container">
            <?php
            // Mendapatkan data berdasarkan keyword pencarian
            $result = $database->searchData($searchKeyword);
